...
const Glowcards = ({ card, children, index }) => {
  ...
  return (
    <div 
        ...
        className="card relative z-40 overflowHidden transition-colors duration-1000 ease-in-out card-border border border-black-50 bg-black-100 timeline-card rounded-xl p-10 mb-5 break-inside-avoid-column">
